    ...
    <div className='fixed top-[20%] left-[30vw] h-[60%] w-[50vw] bg-white shadow-xl  shadow-black grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 '>
                 ...
                 <div className='flex justify-center gap-10 sticky top-0'>
                      <div className='mt-10 ml-10'>
                         <img src={product?.image[0].url} alt=""  className='h-10 w-10 mb-5  border-gray-300 border-2 rounded-[5px] hover:border-black ' onClick={()=>{setImg(product.image[0].url)}}/>
                         <img src={product?.image[1].url} alt="" className='h-10 w-10 mb-5 border-gray-300 border-2 rounded-[5px] hover:border-black' onClick={()=>{setImg(product.image[1].url)}}/>
                         <img src={product?.image[2].url} alt="" className='h-10 w-10 mb-5 border-gray-300 border-2  rounded-[5px] hover:border-black' onClick={()=>{setImg(product.image[2].url)}}/>
                         <img src={product?.image[3].url} alt="" className='h-10 w-10 mb-5 border-gray-300 border-2  rounded-[5px] hover:border-black' onClick={()=>{setImg(product.image[3].url)}}/>
                     </div>
                      <div className='mt-20'>
                ...
                <div className='h-[100%] w-full bg-gray-300 text-center overflow-y-auto'>
                  ...
                  <div className='flex gap-1 h-[20%] w-[90%] bg-white shadow-md shadow-black ml-5 mt-3 relative rounded-[10px]'>
                   <img src={bids?.User?.image?.url} alt="" className='h-[100%] w-[25%]' />
                   <div>
                   ...
                   <div className='h-[100%] w-[30%] bg-gray-200'>
                     ...
                     <button className='text-sm   mt-5 text-gray-400 p-1 rounded-[5px]' onClick={()=>{setreadmsg(bids._id)}} >read message</button>
                   </div>
                   {/* readmsg component */}
                   {readmsg===bids._id?
